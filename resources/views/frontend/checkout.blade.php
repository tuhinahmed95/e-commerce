                                        ...
                                        <div class="billing-adress">
                                            <div class="contact-form form-style">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        <input type="text" id="fname2" name="lname" value="{{ Auth::guard('customer')->user()->lname }}">
                                                    </div>
                                                    <div class="col-lg-6 col-md-12 col-12">
                                    ...
                                    <div class="oreder-item">
                                        ...
                                        @foreach ($carts as $cart)
                                            <div class="oreder-product">
                                                <div class="images">
                                                    <span>
                                                        <img style="max-width: 100px" src="{{ asset($cart->ret_to_product->preview) }}" alt="">
                                                    </span>
                                                </div>
                                                &nbsp;
                                                <div class="product">
                                                    <ul>
                                                        <li class="first-cart">{{  ($cart->ret_to_product->product_name) }} (x{{ $cart->quantity }}) </li>
                                                        <li>
                                                ...
                                                <span>&#2547;{{  ($cart->ret_to_product->after_discount*$cart->quantity) }}</span>
                                            </div>
                                        @endforeach
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <ul>
                                                ...
                                                <li class="free">
                                                    <input data-charge="{{ session('total') }}" id="Local" type="radio" name="charge" class="charge" value="120">
                                                    <label for="Local">Outside City: <span>&#2547;120</span></label>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="title s2">
                                            <h2>Total<span></span><span id="total">&#2547;{{ session('total') }}</span></h2>
                                        </div>
                                    </div>
                                </div>
...
@section('footer_script')
    <script>
        $('.charge').click(function(){
            ...
            var total = parseInt(charge)+ parseInt(total);
            $('#total').html(total);
        })
    </script>
