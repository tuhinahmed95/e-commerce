        ...
        <!-- end preloader -->
             ...
             <div class="tp-login-area">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="tp-accountWrapper" action="{{ route('resend.email.verification.link') }}" method="POST">
                                @csrf
                                ...
                                <div class="tp-accountForm form-style">
                                    ...
                                    <p class="subText">Don't have an account? <a href="{{ route('customer.register') }}">Create free account</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
