    ...
    <main>
      <div id="details" class="clearfix">
        @php
            ...
            $shif = App\Models\Shipping::where('order_id', $order_id)->first();
        ...
        <div id="client">
          ...
          <br>
          <div>
            <div class="to">shifped TO:</div>
            <h2 class="name">{{ $shif->shif_fname }}</h2>
            <div class="address">{{ $shif->shif_address }}, {{ $shif->rel_to_city->name }} {{ $shif->shif_zip }}, {{ $shif->rel_to_country->name }}</div>
            <div class="email"><a href="mailto:john@example.com">{{ $shif->shif_email }}</a></div>
          </div>
        </div>
        <div id="invoice">
